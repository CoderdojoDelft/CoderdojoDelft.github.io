    ...
    dojos() {
        return (
            <React.Fragment>
                ...
                <p>Als de CdoderDojo online plaatsvindt, ontvang je hier de dag voor de dojo instructies over. Meer informatie over online dojo's kun je <Link to={routes.remote.url}>hier</Link> vinden.</p>
